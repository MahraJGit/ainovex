...
const traits = [
  { icon: "/icons/careers/look-for/attitude.svg", number: "01", title: "Positive Attitude", description: "We look for people who bring energy, not excuses. A good attitude is contagious. It turns a tough day into a team win, and a workplace into a place people actually enjoy." },
  { icon: "/icons/careers/look-for/problem-solving.svg", number: "02", title: "Problem Solving Mindset", description: "Challenges come up. What matters is how you handle them. We value people who stay calm, think clearly, and find smart solutions instead of getting stuck on the problem." },
  { icon: "/icons/careers/look-for/teamwork.svg", number: "03", title: "Teamwork", description: "No one builds something great alone. We look for people who listen well, speak up when needed, and put the team's success above personal credit." },
  { icon: "/icons/careers/look-for/professionalism.svg", number: "04", title: "Professionalism", description: "Trust is earned through small things, done right, every time. We value honesty, accountability, and people who follow through on what they say they'll do." },
  { icon: "/icons/careers/look-for/learning.svg", number: "05", title: "Willingness to Learn", description: "The best people never stop growing. We look for curiosity, a hunger to improve, and the humility to learn something new, even from mistakes." },
];
...
export default function WhatWeLookFor() {
  ...
  const updateActiveFromCursor = useCallback(() => {
    ...
    for (let i = 0; i < rowRefs.current.length; i++) {
      ...
      if (x >= rect.left && x <= rect.right && y >= rect.top && y <= rect.bottom) { found = i; break; }
    }
      ...
      <div className="section-container relative z-10 py-[104px]! lg:py-[120px]!">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-16 mb-16">
          ...
          <div className="flex items-center justify-center lg:justify-end">
            <p className="text-base leading-snug text-ink text-center lg:text-right max-w-sm lg:max-w-none">
        ...
        {/* Timeline — hidden on mobile, shown on md+ */}
        <div
